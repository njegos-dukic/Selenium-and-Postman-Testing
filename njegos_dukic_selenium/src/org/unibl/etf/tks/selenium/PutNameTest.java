...
public class PutNameTest {
    ...
    public void testName() throws InterruptedException {
	    ...
	    assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr/td[1]")).getText(), is("Njegos Dukic Updated"));
	    driver.quit();
    }
}
